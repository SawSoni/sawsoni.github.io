   ...
   <%-- <asp:ScriptManager runat="server" ID="First"></asp:ScriptManager>--%>
    <div id="content">
        ...
        <div class="content" style="margin-left: 20px;">
            ...
            <asp:RequiredFieldValidator ControlToValidate="txt_country" ValidationGroup="Reg" Display="Dynamic" ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter Country"></asp:RequiredFieldValidator>

            <br />
            <br />
            <b>City:</b><br />
            <asp:TextBox ID="txt_city" CssClass="large-field" PlaceHolder="City" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ControlToValidate="txt_city" ValidationGroup="Reg" Display="Dynamic" ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter City"></asp:RequiredFieldValidator>

            <br />
            <br />
            <b>E-Mail Address:</b><br />
            <asp:TextBox ID="txt_email" CssClass="large-field" PlaceHolder="Email Id" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ControlToValidate="txt_email" ValidationGroup="Reg" Display="Dynamic" ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Email-ID"></asp:RequiredFieldValidator>
            ...
            <asp:RequiredFieldValidator ControlToValidate="txt_mobile" ValidationGroup="Reg" Display="Dynamic" ID="RequiredFieldValidator2" runat="server" ErrorMessage="Enter Mobile Number"></asp:RequiredFieldValidator>
                ...
                <ContentTemplate>
                    <div class="row">
                        <div class="col-md-3 col-xs-4">
                            ...
                            <asp:ImageButton ID="btnRefresh" Style="width: 30%;" CausesValidation="false" OnClick="btnRefresh_Click1" ImageUrl="images/reset-icon.png" runat="server" />
        ...
        <div class="buttons" style="margin: 0px 0px 0px 20px;">
            <div class="left">
                <asp:Button ID="btn_submit" runat="server" CssClass="button" Text="Submit" OnClick="btn_submit_Click" ValidationGroup="Reg" />
            </div>
        </div>
