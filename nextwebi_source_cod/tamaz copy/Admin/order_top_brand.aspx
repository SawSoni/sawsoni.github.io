<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.master" AutoEventWireup="true" CodeFile="order_top_brand.aspx.cs" Inherits="Admin_order_top_brand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        ...
        function ArrengeCategory(category) {
            ...
            var url = '<%= ResolveUrl("~/Backend.asmx/ARRANGEProductBrand") %>';
        ...
        function PopulateCategory() {
            ...
            var apikey = getKey("apiKey");
            var category = $('#<%=ddl_category.ClientID %> option:selected').val();
            var url = '<%= ResolveUrl("~/Backend.asmx/BrandInOrder") %>';
            var parameter = { "category": category, "apiKey": apikey };
            $.ajax({
                type: 'POST',
                url: url,
