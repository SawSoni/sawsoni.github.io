<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/main.master" AutoEventWireup="true" CodeFile="SubCategorySeo.aspx.cs" Inherits="Admin_SubCategorySeo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="well">
        <asp:DropDownList ID="ddl_category" runat="server" 
             OnSelectedIndexChanged="ddl_category_SelectedIndexChanged" DataTextField="category" 
            DataValueField="category" AutoPostBack="True">
        </asp:DropDownList>
  <br />
        <asp:DropDownList ID="ddl_sub_category" runat="server"></asp:DropDownList>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            <SelectParameters>
                <asp:ControlParameter ControlID="ddl_category" Name="category_name" 
