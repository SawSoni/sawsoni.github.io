            ...
            if (fileupload_small.HasFile)
            {
                ...
                if (1 == 1)
                {
                    if ((fileExtension1 == ".jpg" || fileExtension1 == ".jpeg" || fileExtension1 == ".png" || fileExtension1 == ".gif"))
                    {
                        ...
                        cmd.Parameters.Add("@discount_price", SqlDbType.VarChar).Value = "";
                        cmd.Parameters.Add("@final_price", SqlDbType.VarChar).Value = "";
                        ...
                        cmd.Parameters.Add("@supplier_guid", SqlDbType.VarChar).Value = "Tamaz Global";
                        cmd.Parameters.Add("@category_order_value", SqlDbType.VarChar).Value = "100";
                        cmd.Parameters.Add("@other_sort", SqlDbType.VarChar).Value = "0";
                        con.Open();
                        cmd.ExecuteNonQuery();
